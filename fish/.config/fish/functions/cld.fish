function cld --argument provider
    ...
    switch "$provider"
        case proxy
            set -a env_args ANTHROPIC_BASE_URL=https://your-proxy.example.com
            set -a env_args ANTHROPIC_AUTH_TOKEN=your-api-key
        case glm
            set -a env_args ANTHROPIC_BASE_URL=https://your-provider.example.com
            set -a env_args ANTHROPIC_AUTH_TOKEN=your-api-key
        ...
        case kimi
            set -a env_args ANTHROPIC_BASE_URL=https://your-provider.example.com
            set -a env_args ANTHROPIC_API_KEY=your-api-key
